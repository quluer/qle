...
INSERT INTO `ims_ewei_shop_member_message_template_type` VALUES ('16', '卡路里变动提醒', 'backpoint_ok', 'OPENTM207509450', '', '卡路里变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得卡路里：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前卡路里：{{keyword4.DATA}}{{remark.DATA}}', 'sys', '系统消息通知', '0');
...
INSERT INTO `ims_ewei_shop_member_message_template_type` VALUES ('25', '卡路里兑换成功通知', 'exchange_score', 'OPENTM207509450', '', '卡路里变动提醒', '{{first.DATA}}获得时间：{{keyword1.DATA}}获得卡路里：{{keyword2.DATA}}获得原因：{{keyword3.DATA}}当前卡路里：{{keyword4.DATA}}{{remark.DATA}}', 'exchange', '兑换中心消息通知', '0');
...
CREATE TABLE `ims_ewei_shop_perm_log` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=1579 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('10', '10', 'creditshop', 'biz', '卡路里商城', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/creditshop.jpg', '', '0', '0', '0');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('24', '29', 'sign', 'tool', '卡路里签到', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/sign.jpg', '', '0', '0', '1');
