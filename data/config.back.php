...
//lao
//$config['db']['master']['host'] = '101.37.158.62';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$config['cookie']['pre'] = 'dbe3_';
$config['cookie']['domain'] = '';
$config['cookie']['path'] = '/';


// --------------------------  CONFIG REDIS  --------------------------- //
$config['setting']['redis']['server'] = '101.37.158.62';//本地服务器，如果是远程服务器就用服务器的ip
$config['setting']['redis']['port'] = 6379;//微擎官方是6379，但是人人商城官方为了安全的建议是63790，记得这个端口要在防火墙打开
$config['setting']['redis']['pconnect'] = 0;
$config['setting']['redis']['timeout'] = 100;
...
$config['setting']['memcache']['timeout'] = 300;
