...
<div class='fui-page fui-page-current'>
    ...
    <div class='fui-content navbar'>
        ...
        <div class="fui-title">卡路里抵扣设置</div>
        <div class="fui-cell-group fui-cell-click">
            <div class="fui-cell">
                <div class="fui-cell-label">卡路里</div>
                <div class="fui-cell-info">
                    <input type="number" placeholder="最多抵扣" class="fui-input" value="<?php  echo $item['deduct']?>" id="deduct" />
                </div>
