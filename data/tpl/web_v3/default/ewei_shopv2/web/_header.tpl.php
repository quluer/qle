            ...
            <div class="panel-group" id="panel-accordion">
                ...
                <?php  } ?>
                 ...
                 <?php  if(!$system['merch']) { ?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingSex" data-toggle="collapse" data-parent="#panel-accordion" href="#collapseSex" aria-expanded="false" aria-controls="collapseSex">
                            <h4 class="panel-title">
                                <i class="icow icow-gonggao"></i> <a>达人圈</a> <span></span>
                            </h4>
                        </div>
                        <div id="collapseSex" class="panel-collapse collapse <?php  if($_W['routes']=='sysset.senword') { ?>in<?php  } ?>" role="tabpanel" aria-labelledby="headingTwo">
                            <ul class="panel-body">
                                
                               <!--  <li class="panel-list small" style="padding: 10px;">
                                    <a class="panel-list-text text-center" href="<?php  echo webUrl('sysset/senword')?>"><span class="text-primary">敏感词</span></a>
                                </li> -->
                                
                                <li class="panel-list small" style="padding: 10px;">

                                  <a class="panel-list-text" href="<?php  echo webUrl('sysset/senword/circle')?>">待审核 <span class="pull-right text-warning">(<?php  echo $system['drcircle'];?>)</span> </a>
                                </li>
                   ...
                   <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingSeven" data-toggle="collapse" data-parent="#panel-accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            <h4 class="panel-title">
                                <i class="icow icow-gonggao"></i> <a>问题反馈</a> <span></span>
                            </h4>
                        </div>
                        <div id="collapseSeven" class="panel-collapse collapse <?php  if($_W['routes']=='sysset.question') { ?>in<?php  } ?>" role="tabpanel" aria-labelledby="headingSeven">
                            <ul class="panel-body">
                               ...
                               <!--  <li class="panel-list small" style="padding: 10px;">
                                ...
                                <li class="panel-list small" style="padding: 10px;">
                                  ...
                                  <a class="panel-list-text" href="<?php  echo webUrl('sysset/question')?>">待处理 <span class="pull-right text-warning">(<?php  echo $system['question'];?>)</span> </a>
                                </li>
