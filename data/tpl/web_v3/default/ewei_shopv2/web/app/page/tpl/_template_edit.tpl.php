            ...
            <div class="item" data-id="<%itemid%>">
                ...
                <div class="item-form">
                    ...
                    <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                        ...
                        <input type="text" class="form-control input-sm diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="linkurl" data-bind-init="true" id="curl-<%itemid%>" placeholder="请选择链接地址" value="<%child.linkurl%>" />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group form-group" style="margin: 0;">
                ...
                <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="link" data-bind-init="true" placeholder="请选择链接地址" value="<%params.link%>" id="titlelink" />
                ...
                <div class="item-body">
                    ...
                    <div class="item-form">
                        ...
                        <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                            ...
                            <input type="text" class="form-control input-sm diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="linkurl" data-bind-init="true" id="curl-<%itemid%>" placeholder="请选择链地址" value="<%child.linkurl%>" />
    ...
    <div class="tab-content" data-tab="goods" style="display: block;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <label class="radio-inline"><input type="radio" name="goodsdata" value="9" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='9'%>checked="checked"<%/if%> > 卡路里兑换商品</label>

                <label class="radio-inline"><input type="radio" name="goodsdata" value="10" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='10'%>checked="checked"<%/if%> > 卡路里抽奖商品</label>
                ...
                <div class="item" data-id="<%itemid%>">
                    ...
                    <div class="item-form">
                        ...
                        <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                            ...
                            <span class="input-group-addon">卡路里</span>
            ...
            <div class="item" data-id="<%itemid%>">
                ...
                <div class="item-form">
                    ...
                    <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                        ...
                        <input type="text" class="form-control input-sm diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="linkurl" id="curl-<%itemid%>" placeholder="<% if index != 0 %>请选择数据或选择链接地址<%else%>请选择数据<%/if%>" value="<%child.linkurl%>" />
