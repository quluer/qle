...
<div class="page-header">当前位置：<span class="text-primary"><?php  if($type=='credit1') { ?>卡路里<?php  } else if($type=='credit3') { ?>折扣宝<?php  } else if($type=='credit2') { ?>余额<?php  } else if($type=='credit4') { ?>贡献值<?php  } else if($type=='RVC') { ?>RVC<?php  } ?>明细</span></div>
        ...
        <div class="page-toolbar">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <?php  } else if($type=='credit3') { ?>

                        <?php if(cv('finance.credit.credit3.export')) { ?>

                        <button type="submit" name="export" value="3" class="btn btn-success ">导出</button>

                        <?php  } ?>
                    <?php  } else if($type=='credit4') { ?>

                        <?php if(cv('finance.credit.credit4.export')) { ?>

                        <button type="submit" name="export" value="4" class="btn btn-success ">导出</button>

                        <?php  } ?>
                    <?php  } else if($type=='RVC') { ?>

                        <?php if(cv('finance.credit.RVC.export')) { ?>

                        <button type="submit" name="export" value="5" class="btn btn-success ">导出</button>
        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th style='width:80px;'><?php  if($type=='credit1') { ?>卡路里<?php  } else if($type=='credit3') { ?>折扣宝<?php  } else if($type=='credit4') { ?>贡献值<?php  } else if($type=='RVC') { ?>RVC<?php  } else { ?>余额<?php  } ?>变化</th>
                ...
                <tr >
                    ...
                    <td><?php  if($type == "RVC" && $row['type'] == 0) { ?><?php  echo $row['realmoney'];?><?php  } else if($type == "RVC" && $row['type'] == 2) { ?><?php  echo $row['money'];?><?php  } else { ?><?php  echo $row['num'];?><?php  } ?></td>
