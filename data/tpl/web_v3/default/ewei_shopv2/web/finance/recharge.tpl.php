...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <?php  } ?>
                            <?php if(cv('finance.recharge.credit3')) { ?>
                            <li <?php  if($type=='credit3') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-3"  data-rechargetype="credit3" aria-expanded="false"> 充值折扣宝</a></li>
                            <?php  } ?>
                        ...
                        <div class="tab-content ">
                            ...
                            <div id="tab-3" class="tab-pane <?php  if($type=='credit3') { ?>active<?php  } ?>">

                                <div class="form-group"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">当前折扣宝</label>
                                    <div class="col-sm-9 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <label class='radio-inline'>
                            <input type='radio' name='changetype' value='2' /> 最终<span class='name'><?php  if($type=='credit1') { ?>卡路里<?php  } else if($type=="credit2") { ?>余额<?php  } else if($type="credit3" ) { ?>折扣宝<?php  } ?></span>
                        </label>
                    </div>
                </div>
            ...
            <button class="btn btn-primary btn-submit" type="submit">确认充值<?php  if($type=='credit1') { ?>卡路里<?php  } else if($type == 'credit2') { ?>余额<?php  } else if($type='credit3') { ?>折扣宝<?php  } ?></button>
