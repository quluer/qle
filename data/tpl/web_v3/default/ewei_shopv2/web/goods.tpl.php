            ...
            <div class="input-group col-sm-6 pull-right">
                <span class="input-group-select">
                    <select name="attribute" class='form-control select2' style="width:200px;" data-placeholder="商品属性">
                        ...
                        <option value="klldiscount" <?php  if($_GPC['attribute'] == 'klldiscount') { ?>selected<?php  } ?> >卡路里免费兑</option>
                        <option value="zkbdiscount" <?php  if($_GPC['attribute'] == 'zkbdiscount') { ?>selected<?php  } ?> >折扣宝0元兑</option>
                    </select>
                </span>
                <span class="input-group-select">
