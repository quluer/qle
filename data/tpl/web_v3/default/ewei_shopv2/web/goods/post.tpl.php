    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <!--<li <?php  if($_GPC['tab']=='app') { ?>class="active"<?php  } ?> ><a href="#tab_app">app详情</a></li>-->
            ...
            <div class="tab-content  ">
                ...
                <div class="tab-pane <?php  if($_GPC['tab']=='app') { ?>active<?php  } ?>" id="tab_app"> <div class="panel-body" style='padding:0;'><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/tab/app', TEMPLATE_INCLUDEPATH)) : (include template('goods/tab/app', TEMPLATE_INCLUDEPATH));?></div></div>
