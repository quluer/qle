<?php defined('IN_IA') or exit('Access Denied');?><div class="region-goods-details row">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
            <select class="form-control tpl-category-parent select2" id="icon_id" name="icon_id">
                <?php  if(empty($item['icon'])) { ?><option value="0">不选择活动</option><?php  } ?>
                <?php  if(is_array($icon)) { foreach($icon as $cate) { ?>
                    <option value="<?php  echo $cate['id'];?>" <?php  if($item['icon_id'] == $cate['id']) { ?>selected="true"<?php  } ?>><?php  echo $cate['title'];?></option>
                <?php  } } ?>
            </select>
        </div>
    </div>
...
<div class="form-group">
    ...
    <label class="col-sm-2 control-label">升级等级</label>

    <div class="col-sm-8 col-xs-12">

        <select id="agentlevel"  name='agentlevel' class="form-control " style='width:605px;' >
            <option value="0" >不升级</option>
            <?php  if(is_array($agentlevels)) { foreach($agentlevels as $c) { ?>
            <option value="<?php  echo $c['id'];?>" <?php  if($c['id']==$item['agentlevel'] ) { ?>selected<?php  } ?> ><?php  echo $c['levelname'];?></option>
            <?php  } } ?>
        </select>
    </div>
...
<div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        ...
        <div class="form-group dispatch_info" <?php  if(($item['type'] == 2  || $item['isverify']==2 || $item['type'] == 3 || $item['type'] == 5 || $item['type'] == 10)) { ?>style="display: none;"<?php  } ?>>
            <label class="col-sm-2 control-label">基础地区</label>
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                    <div id="areas" class="form-control-static select2-container select2-container-multi form-control">
                        <ul class="select2-choices">
                            <?php  if($item['edareas']) { ?>
                            <?php  if(is_array(explode(';',trim($item['edareas'],";")))) { foreach(explode(';',trim($item['edareas'],";")) as $val) { ?>
                            <li class="select2-search-choice"><div><?php  echo $val;?></div><a href="javascript:;" class="select2-search-choice-close close" tabindex="-1"></a></li>
                            <?php  } } ?>
                            <?php  } else { ?>
                            <?php  if(is_array(explode(';',trim($express,";")))) { foreach(explode(';',trim($express,";")) as $val) { ?>
                            <li class="select2-search-choice"><div><?php  echo $val;?></div><a href="javascript:;" class="select2-search-choice-close close" tabindex="-1"></a></li>
                            <?php  } } ?>
                            <?php  } ?>
                        </ul>
        ...
        <div class="col-sm-6 col-xs-6" style='padding-left:0'>
            ...
            <div class='form-control-static'><?php  if(empty($item['dispatchtype'])) { ?>运费模板 <?php  if($item['dispatchid'] == 0) { ?>默认模板<?php  } else { ?><?php  if(is_array($dispatch_data)) { foreach($dispatch_data as $dispatch_item) { ?><?php  if($item['dispatchid'] == $dispatch_item['id']) { ?><?php  echo $dispatch_item['dispatchname'];?><?php  } ?><?php  } } ?><?php  } ?><?php  } else { ?>基础邮费<?php  } ?></div>
    ...
    <div class="col-sm-6 col-xs-6" style='padding-left:0'>
        ...
        <div class="input-group">
            ...
            <span class='input-group-addon' style='border:none'><label class="radio-inline"  style='margin-top:-7px;' ><input type="radio"name="dispatchtype" value="1" <?php  if($item['dispatchtype'] == 1) { ?>checked="true"<?php  } ?>  /> 基础邮费</label></span>
        ...
        <span class="help-block">如果开启了同城配送，同城运费根据基础邮费进行计算</span>
...
<div class="form-group dispatch_info" <?php  if(($item['type'] == 2  || $item['isverify']==2 || $item['type'] == 3 || $item['type'] == 5 || $item['type'] == 10)) { ?>style="display: none;"<?php  } ?>>
    ...
    <div class="form-group dispatch_info">
        <label class="radio-inline"><input type="radio" name="is_remote" value="0" <?php  if($item['is_remote'] == 0) { ?>checked="true"<?php  } ?>/> 不支持偏远地区</label>
    </div>
    ...
    <div class="col-sm-6 col-xs-6" style='padding-left:0;margin-left: 16.5%;'>
        ...
        <div class="input-group">
            ...
            <span class='input-group-addon' style='border:none'><label class="radio-inline"  style='margin-top:-7px;' ><input type="radio" name="is_remote" value="1" <?php  if($item['is_remote'] == 1) { ?>checked="true"<?php  } ?>  /> 偏远加邮费</label></span>

            <input type="text" name="remote_dispatchprice" id="remote_dispatchprice" class="form-control" value="<?php  echo $item['remote_dispatchprice'];?>" />
...
<div class="form-group">
    ...
    <label class="col-sm-2 control-label">年卡特权区商品</label>

    <div class="col-sm-9 col-xs-12">

        <?php if( ce('goods' ,$item) ) { ?>

        <label class="radio-inline"><input type="radio" name="is_right" value="1" <?php  if(!empty($item['is_right'])) { ?>checked="true"<?php  } ?>/> 是</label>

        <label class="radio-inline"><input type="radio" name="is_right" value="0" <?php  if(empty($item['is_right'])) { ?>checked="true"<?php  } ?>/> 否</label>

        <?php  } else { ?>

        <div class='form-control-static'><?php  if(empty($item['is_right'])) { ?>否<?php  } else { ?>是<?php  } ?></div>
