    ...
    <div class="region-goods-right col-sm-10">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <p class="help-block">
                    会员购物赠送的卡路里, 如果不填写或填写0，则默认为不赠送卡路里，如果带%则为按成交价格的比例计算卡路里
                </p>
                <p class="help-block">
                    如: 购买2件，设置10 卡路里, 不管成交价格是多少， 则购买后获得20卡路里
                </p>
                <p class="help-block">
                    如: 购买2件，设置10%卡路里, 成交价格2 * 200= 400， 则购买后获得 40 卡路里（400*10%）
                </p>
                <?php  } else { ?>
                <div class='form-control-static'>
    ...
    <div class="region-goods-right col-sm-10">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                <div class="input-group fixsingle-input-group">
                    <input type="text" name="agent_devote" id="agent_devote" class="form-control" value="<?php  echo $item['agent_devote'];?>"/>
                <span class="input-group-addon">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                <div class="input-group fixsingle-input-group">
                    <input type="text" name="my_devote" id="my_devote" class="form-control" value="<?php  echo $item['my_devote'];?>"
                    />
                <span class="input-group-addon">
...
<div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        ...
        <div class="form-group" style="margin-left:125px;">
           <div class="col-sm-9 col-xs-12">
            <label class="radio-inline"><input type="radio" name="deduct_type" value="1" <?php  if($item['deduct_type'] == 1) { ?>checked="true"<?php  } ?>   /> 卡路里抵扣</label>
		   <label class="radio-inline"><input type="radio" name="deduct_type" value="2" <?php  if($item['deduct_type'] == 2) { ?>checked="true"<?php  } ?>/>折扣宝抵扣</label>
           </div>
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('goods' ,$item) ) { ?>
                <div class='input-group fixsingle-input-group'>
            ...
            <span class="help-block">
                ...
                <?php  } else { ?>
                <div class='form-control-static'>
                    <?php  if(empty($item['deduct'])) { ?>不支持卡路里抵扣<?php  } else { ?>最多抵扣 <?php  echo $item['deduct'];?> 元 <?php  if(empty($item['manydeduct'])) { ?>不允许多件累计抵扣<?php  } else { ?>允许多件累计抵扣
                    <?php  } ?><?php  } ?>
                </div>
                <?php  } ?>
            </div>
