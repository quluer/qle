...
<div class="page-content">
    ...
    <div class="fixed-header">
        ...
        <div class="flex1">卡路里/余额/折扣宝/贡献值</div>
    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <div class="page-toolbar">
            ...
            <select name='isblack' class='form-control'>
                ...
                <input type="text" class="form-control " name="realname" value="<?php  echo $_GPC['realname'];?>" placeholder="可搜索昵称/姓名/手机号/ID/微信号">
                ...
                <table class="table table-responsive">
                    ...
                    <tbody>
                        ...
                        <?php  } ?> <br/>
                            ...
                            <td>
                                <?php  echo intval($row['shopkeeperallcount'])?> / <?php  echo intval($row['shopkeepercount'])?>
                            </td>
                            <!-- 所有/直-->
                            <td>
                                 <?php  echo intval($row['agentallcount'])?> /

                                <a href="<?php  echo webUrl('member/list', array('agentid'=>$row['id']))?>" >
                                <?php  echo intval($row['agentcount'])?>
                                </a>
                            </td>
                            ...
                            <td>
                                <span >卡路里:  <span style="color: #5097d3"><?php  echo price_format($row['credit1'],2)?></span> </span>
                                <br/><span >余&nbsp;&nbsp;&nbsp;额:  <span style="color: #5097d3"><?php  echo price_format($row['credit2'],2)?></span> </span>
                                <br/><span>折扣宝: <span class="text-warning"><?php  echo price_format($row['credit3'],2)?> </span></span>
                                <br/><span>贡献值: <span class="text-warning"><?php  echo price_format($row['credit4'],2)?> </span></span>
                            </td>
                            ...
                            <td style="overflow:visible;text-align: center;">
                                ...
                                <div class="btn-group">
                                       ...
                                       <a class="btn  btn-op btn-operation" data-toggle="ajaxModal"
                                        ...
                                        <a class="btn  btn-op btn-operation" href="<?php  echo webUrl('finance/credit/credit1', array('keyword'=>$row['nickname']))?>"

                                               title=''>

                                                   <span data-toggle="tooltip" data-placement="top" title="" data-original-title="卡路里明细">
                                        ...
                                        <a class="btn  btn-op btn-operation" href="<?php  echo webUrl('finance/credit/credit2', array('keyword'=>$row['nickname']))?>" title=''>
                                               <span data-toggle="tooltip" data-placement="top" title="" data-original-title="余额明细">
                                                   <i class='icow icow-dingdan2'></i>
                                                </span>
                                        </a>

                                        <a class="btn btn-op btn-operation" href="<?php  echo webUrl('finance/credit/credit3', array('keyword'=>$row['nickname']))?>"

                                           title='折扣宝明细'>

                                                   <span data-toggle="tooltip" data-placement="top" title="" data-original-title="折扣宝明细">
                                        ...
                                        <a class="btn  btn-op btn-operation" href="<?php  echo webUrl('finance/credit/credit4', array('keyword'=>$row['nickname']))?>" title=''>
                                               <span data-toggle="tooltip" data-placement="top" title="" data-original-title="贡献值明细">
                                                   <i class='icow icow-dingdan2'></i>
                                                </span>
                                        </a>

                                        <a class="btn btn-op btn-operation" href="<?php  echo webUrl('member/list/fansinfo', array('openid'=>$row['openid']))?>"

                                           title='粉丝明细' data-toggle="ajaxModal">

                                               <span data-toggle="tooltip" data-placement="top" title="" data-original-title="粉丝明细">
                                        ...
                                        <a class="btn  btn-op btn-operation" href="<?php  echo webUrl('member/list/memberlog', array('openid'=>$row['openid']))?>" title=''>
                                           <span data-toggle="tooltip" data-placement="top" title="" data-original-title="会员log">
                                               <i class='icow icow-dingdan2'></i>
                                            </span>
                                        </a>
