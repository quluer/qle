...
<div class="page-content">
    <div class="alert alert-primary">
        ...
        <div class="col-lg pull-right" style="margin-top:-28px;text-align: right" >
            <?php if(cv('sysset.game')) { ?>
                <input type="hidden" name="game_id" value="<?php  echo $data['id'];?>">
                <input type="checkbox" class="js-switch" name="status" value="<?php  echo $data['status'];?>" <?php  if($data['status']==1) { ?>checked<?php  } ?> />
            <?php  } ?>
        </div>
    </div>
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <?php  } ?>
        <?php  if(is_array($data['sets'])) { foreach($data['sets'] as $key=>$item) { ?>
            <div class="game">
        ...
        <div class="game">
            ...
            <input style="float: left;margin-left: 8%" type="radio" name="game_type" value="1" <?php  if($data['game_type'] == 1 || isset($data['game_type'])) { ?>checked<?php  } ?>><span style="float: left;margin-left: 1%;margin-top: 3px">卡路里</span>
            <input style="float: left;margin-left: 8%" type="radio" name="game_type" value="2" <?php  if($data['game_type'] == 2) { ?>checked<?php  } ?>><span style="float: left;margin-left: 1%;margin-top: 3px">折扣宝</span>
        </div>
