...
<div class="page-header">当前位置：<span class="text-primary">商城设置</span></div>
    ...
    <div class="page-content">
        <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                <label class="col-lg control-label">签到赠送步数</label>
                <div class="col-sm-9 col-xs-12">
                    <input class="form-control" name="data[qiandao]" value="<?php  echo intval($data['qiandao'])?>"/>
                    <span class="help-block">每日签到赠送步数</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg control-label">助力送步数</label>
                <div class="col-sm-9 col-xs-12">
                    <input class="form-control" name="data[zhuli]" value="<?php  echo intval($data['zhuli'])?>"/>
                    <span class="help-block">助力送步数</span>
                </div>
            </div>
