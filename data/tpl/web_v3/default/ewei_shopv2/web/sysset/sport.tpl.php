...
<meta charset="utf-8"/>
<div class="page-header">当前位置：<span class="text-primary">运动首页</span></div>

    <div class="page-content">
        <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
           
            <div class="form-group">
                <label class="col-lg control-label">悬浮币背景图</label>
    ...
    <img src="<?php  echo tomedia($data['icon'][0]['img'])?>" id="icon1_img" style="width:100px;height:100px">
     ...
     <input type="button"  onclick="select_file()" value="上传"  style="background: #44abf7 !important; border-color: #44abf7 !important;color: #fff !important;width:150px;height:30px;">
       ...
       <div class="col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                <label class="col-lg control-label">栏目ICON-1 角标</label>
                <div class="col-sm-9 col-xs-12">
                  
                    <?php  echo tpl_form_field_image2('icon1', $data['icon'][0]['icon'])?>
    ...
    <img src="<?php  echo tomedia($data['icon'][1]['img'])?>" id="icon2_img" style="width:100px;height:100px">
     ...
     <input type="button"  onclick="select_file2()" value="上传"  style="background: #44abf7 !important; border-color: #44abf7 !important;color: #fff !important;width:150px;height:30px;">
          ...
          链接：<input type="text" name="icon2_url" class="form-control" value="<?php  echo $data['icon'][1]['url'];?>" />
            ...
            <div class="form-group">
                <label class="col-lg control-label">栏目ICON-2 角标</label>
                <div class="col-sm-9 col-xs-12">
                  
                    <?php  echo tpl_form_field_image2('icon2', $data['icon'][1]['icon'])?>
    ...
    <img src="<?php  echo tomedia($data['icon'][2]['img'])?>" id="icon3_img" style="width:100px;height:100px">
     ...
     <input type="button"  onclick="select_file3()" value="上传"  style="background: #44abf7 !important; border-color: #44abf7 !important;color: #fff !important;width:150px;height:30px;">
          ...
          链接：<input type="text" name="icon3_url" class="form-control" value="<?php  echo $data['icon'][2]['url'];?>" />
            ...
            <div class="form-group">
                <label class="col-lg control-label">栏目ICON-3 角标</label>
                <div class="col-sm-9 col-xs-12">
                  
                    <?php  echo tpl_form_field_image2('icon3', $data['icon'][2]['icon'])?>
    ...
    <img src="<?php  echo tomedia($data['icon'][3]['img'])?>" id="icon4_img" style="width:100px;height:100px">
     ...
     <input type="button"  onclick="select_file4()" value="上传"  style="background: #44abf7 !important; border-color: #44abf7 !important;color: #fff !important;width:150px;height:30px;">
          ...
          链接：<input type="text" name="icon4_url" class="form-control" value="<?php  echo $data['icon'][3]['url'];?>" />
            ...
            <div class="form-group">
                <label class="col-lg control-label">栏目ICON-4 角标</label>
                <div class="col-sm-9 col-xs-12">
                  
                    <?php  echo tpl_form_field_image2('icon4', $data['icon'][3]['icon'])?>
...
function fileUpload4(){
    ...
    $.ajax({
             ...
             <div class="form-group">
                <label class="col-lg control-label">栏目ICON-5</label>
                <div class="col-sm-9 col-xs-12">
                    
    <img src="<?php  echo tomedia($data['icon'][4]['img'])?>" id="icon5_img" style="width:100px;height:100px">
     <input name="icon5_img" value="<?php  echo $data['icon'][4]['img'];?>" id="icon5_value" type="hidden">
     <div style="margin-top:20px;margin-left:5%;">
     <input type="file" name="file" id="file5" onchange="fileUpload5()" style="display:none">
     <input type="button"  onclick="select_file5()" value="上传"  style="background: #44abf7 !important; border-color: #44abf7 !important;color: #fff !important;width:150px;height:30px;">
     </div>
     
                   标题：<input type="text" name="icon5_title" class="form-control" value="<?php  echo $data['icon'][4]['title'];?>" />
          链接：<input type="text" name="icon5_url" class="form-control" value="<?php  echo $data['icon'][4]['url'];?>" />
      
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-lg control-label">栏目ICON-5 角标</label>
                <div class="col-sm-9 col-xs-12">
                  
                    <?php  echo tpl_form_field_image2('icon5', $data['icon'][4]['icon'])?>
                ...
                success: function(data) {   //提交成功后自动执行的处理函数，参数data就是服务器返回的数据。
                    ...
                    if(data.status==0){
                    	//添加数据库
                    				...
                    				var _videoPlay = document.getElementById("icon5_img");
                    				 
                    				_videoPlay.src = data.addr;
                    				document.getElementById("icon5_value").value=data.message
